A Tic-tac game that plays against human, this games uses Minimax algorithems this is used in decision making and game theory to find the optimal move for a player,
